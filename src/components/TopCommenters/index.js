...
//Recieves the comments array from the store. Then displays top commenters in descending order, if commenters have an equal ammount of comments it displays in most recent order.
